...
import AOS from 'aos';
import 'aos/dist/aos.css';
import { supabase } from "@/lib/supabaseClient"; // ✅ Use curly braces for named export
      ...
      <Wrapper>
        <form onSubmit={handleSubmit} className="text-center flex flex-col items-center py-8 px-6 rounded-xl shadow-lg bg-white" data-aos="flip-left">
          <fieldset className="w-full max-w-lg border-4 border-teal-500 rounded-xl p-6">
            ...
            <button
              type="submit"
              className="bg-teal-500 py-3 px-8 rounded-lg text-white text-xl  font-semibold hover:scale-105 transition-transform duration-300 hover:shadow-lg focus:outline-none"
            >
              Send Message
            </button>
          </fieldset>
